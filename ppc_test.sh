...
#
### PPC Model Testing 
#EXPERIMENT=work_dir_py/kitti/pvrcnn/3class/joint/0.3/npupdated00002/
...
#	model.data_preprocessor.neighbor_score=0.0002 \
...
#### Baselines
#### Matched Filtering
#EXPERIMENT=work_dir_py/kitti/pvrcnn/3class/joint/0.3/baseline/
#CHECKPOINT=${EXPERIMENT}/epoch_10.pth
#
#SBR=("clean" "5_50" "5_100" "1_50" "1_100")
#for i in "${!SBR[@]}"
