...
points = np.fromfile('data/sunrgbd/points_min2/0.3/argmax-filtering-sbr/1_50/005050.bin', dtype=np.float32)
points = np.fromfile('data/sunrgbd/points_min2/0.048/gaussfilter-argmax-filtering-sbr/1_50/005050.bin', dtype=np.float32)
#points = np.fromfile('data/sunrgbd/points_clean8/001743.bin', dtype=np.float32)
